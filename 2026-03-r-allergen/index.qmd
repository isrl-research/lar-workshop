...
doc-id: iSRL-26-04-R-ALG
description: "Reviews the clinical and epidemiological evidence on food allergens in India, maps it against the FSSAI mandatory allergen declaration framework (Labelling and Display Regulations 2020, operationalised July 2022), and derives a three-tier allergen recognition list for the Indian Food Ingredient Database (IFID)."
date: "2026-03-31"
license: "CC BY 4.0"
citation:
  type: report
  publisher: iSRL
  number: iSRL-26-04-R-ALG
format:
  html:
    toc: true
    toc-depth: 3
